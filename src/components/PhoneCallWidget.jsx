                ...
                >
                    ...
                    >
                        ...
                        <div className="relative flex items-center justify-center w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-black shadow-[inset_0_3px_5px_rgba(0,0,0,1),0_1px_2px_rgba(255,255,255,0.2)] group-hover:bg-[#050505] transition-colors overflow-hidden">
                            ...
                            <PhoneCall size={16} className="text-[#EC4899] drop-shadow-[0_0_8px_rgba(236,72,153,0.8)] z-10 sm:scale-110" fill="currentColor" strokeWidth={1} />

                            {/* Inner hub glow */}
                            <div className="absolute inset-0 bg-[#EC4899]/20 rounded-full blur-[4px] animate-pulse" />
                        </div>
                    </a>
                </motion.div>
            )}
