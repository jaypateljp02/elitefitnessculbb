    ...
    return (
        <div style={{ perspective: 1000 }} className="h-full">
            <motion.div
                ...
                className={`relative h-full rounded-2xl w-full p-[1px] group cursor-pointer ${plan.popular ? '' : plan.isElite ? 'border border-elite-orange/50 shadow-[0_0_40px_rgba(233,111,73,0.2)]' : 'border border-white/10'}`}
            >
