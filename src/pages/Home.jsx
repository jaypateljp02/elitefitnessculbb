            ...
            >
                ...
                >
                    ...
                    <div className="relative flex items-center justify-center">
                        ...
                        <div
                            ...
                            style={{
                                ...
                                border: '1px solid rgba(233,111,73,0.3)',
                                boxShadow: '0 0 20px rgba(233,111,73,0.15), inset 0 0 10px rgba(0,0,0,0.5)',
                            }}
                        />
                        {/* Bar */}
                        <div
                            ...
                            style={{
                                ...
                                border: '1px solid rgba(233,111,73,0.2)',
                                boxShadow: '0 0 10px rgba(233,111,73,0.1)',
                            }}
                        >
                    ...
                    <div
                        ...
                        style={{ background: 'rgba(233,111,73,0.2)' }}
                    />
                </motion.div>
            </div>
            {/* Floating particles */}
    ...
    return (
        <section className="py-8 bg-black border-b border-white/5 overflow-hidden">
            <div className="relative flex overflow-x-hidden group">
                <div className="animate-marquee py-2 whitespace-nowrap flex gap-4 min-w-max">
                    {[...marqueeImages, ...marqueeImages].map((img, i) => (
                        <div key={i} className="w-[300px] h-[200px] sm:w-[400px] sm:h-[250px] relative rounded-2xl overflow-hidden shadow-2xl border border-white/10 shrink-0">
...
function MembershipPreview() {
    ...
    return (
        <section className="py-16 sm:py-28 px-4 relative noise-bg" style={{ background: 'radial-gradient(ellipse at 50% 20%, rgba(233,111,73,0.06) 0%, transparent 50%)' }}>
            <div className="relative z-10 max-w-6xl mx-auto">
                <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-10 sm:mb-16">
                    <p className="text-elite-orange text-sm font-semibold uppercase tracking-widest mb-3">JOIN THE ELITE FORCE /</p>
                ...
                <div className="flex md:hidden justify-center gap-2 mt-2">
                    {plans.map((_, i) => (
                        <div
                            key={i}
                            className={`w-2 h-2 rounded-full transition-all duration-300 ${i === activeIndex ? 'bg-elite-orange w-4' : 'bg-white/20'}`}
                        />
                    ))}
                </div>
...
function Testimonials() {
    ...
    // SEO: JSON-LD Local Business & Reviews Schema
    const structuredData = {
        "@context": "https://schema.org",
        "@type": "HealthAndBeautyBusiness",
        "name": "Elite Fitness Clubb",
        "image": "https://elitefitness.club/asset/Logo.webp",
        "address": {
            "@type": "PostalAddress",
            "streetAddress": "2nd floor, Laxmi Chowk, above KFC, Phase 1",
        ...
        "review": testimonials.slice(0, 5).map(t => ({
            ...
            "reviewBody": t.text,
            "reviewRating": { "@type": "Rating", "bestRating": "5", "ratingValue": t.rating.toString() }
        }))
    }
        ...
        <section className="py-16 sm:py-28 px-4 relative noise-bg" style={{ background: 'radial-gradient(ellipse at 30% 20%, rgba(233,111,73,0.06) 0%, transparent 50%), radial-gradient(ellipse at 70% 80%, rgba(6,182,212,0.04) 0%, transparent 50%)' }}>
            ...
            <div className="relative z-10 max-w-7xl mx-auto">
                ...
                <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-6">
                    <p className="text-elite-orange text-sm font-semibold uppercase tracking-widest mb-3">REAL RESULTS, REAL PEOPLE /</p>
                ...
                <div className="columns-1 sm:columns-2 lg:columns-3 gap-4 sm:gap-5 space-y-4 sm:space-y-5">
                    {visibleTestimonials.map((t, i) => (
                        ...
                        >
                            <div
                                className="relative p-5 sm:p-7 rounded-2xl transition-all duration-500 group-hover:border-elite-orange/30 overflow-hidden"
                                style={{
                ...
                {!showAll && testimonials.length > 6 && (
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="mt-8 text-center">
                        <button
                            ...
                            className="inline-flex items-center gap-2 px-6 py-3 rounded-full text-xs font-bold uppercase tracking-widest text-elite-orange border border-elite-orange/30 hover:bg-elite-orange/10 transition-all"
                        >
                            See More Reviews
                        </button>
                    </motion.div>
