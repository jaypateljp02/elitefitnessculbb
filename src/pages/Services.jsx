...
const zones = [
    ...
    },
    {
        ...
        desc: "Recovery isn't a luxury; it's a protocol. Our dedicated recovery suite features ice bath circuits to reduce inflammation and infrared saunas to accelerate cellular repair. Train more, hurt less.",
        image: '/asset/11.png',
        Icon: Snowflake,
        features: ['Guided Ice Bath & Cold Plunge Protocols', 'Infrared Sauna for Muscle Repair', 'Mobility & Assisted Stretching Therapy'],
    ...
    },
    {
        ...
        zone: 'SERVICE 03',
        zoneNumber: '03',
        name: 'FAT LOSS MASTERY',
        tagline: "DON'T JUST SWEAT. TRANSFORM.",
        desc: "We sell transformation, not treadmill access. Science-backed HIIT and fat-burn conditioning programs designed to maximize caloric expenditure during and after your session.",
        image: '/asset/4-1.png',
        Icon: Zap,
        features: ['Science-Backed HIIT Programming', 'Metabolic Conditioning Circuits', 'Nutrition & Macro Guidance Integration'],
        subTags: ['HIIT', 'Fat Burn', 'Endurance', 'Metabolism'],
        stat: { area: 'CONDITIONING', equipment: 'HIGH INTENSITY' },
        ctaLabel: 'START MY WEIGHT LOSS JOURNEY',
        waLink: "https://wa.me/918888161216?text=Hi%20Elite!%20I%20want%20to%20start%20my%20Fat%20Loss%20and%20Transformation%20journey.",
    ...
    },
    {
        ...
        zone: 'SERVICE 04',
        zoneNumber: '04',
        name: 'BOUTIQUE GROUP FITNESS',
        tagline: 'HIGH ENERGY. ELITE COMMUNITY.',
        desc: "Ditch the crowded, chaotic aerobics classes. Join our intentionally capped, expert-led group sessions ranging from high-energy Zumba to restorative Power Yoga in a premium climate-controlled environment.",
        image: '/asset/16.png',
        Icon: Leaf,
        features: ['Hatha & Power Yoga Sessions', 'Zumba & High-Energy Cardio', 'Intentionally Capped Class Sizes'],
        subTags: ['Stress Relief', 'Mindfulness', 'Dance Fitness', 'Community'],
        stat: { area: 'PRIVATE STUDIO', equipment: 'CAPPED SIZES' },
        ctaLabel: 'JOIN A GROUP CLASS',
        waLink: 'https://wa.me/918888161216?text=Hi,%20please%20share%20the%20schedule%20for%20your%20Boutique%20Group%20Classes.',
